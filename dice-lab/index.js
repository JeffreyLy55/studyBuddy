...
var balance = 0;
var howManyTimes = window.prompt("How many times do you want to play?");
...
function whoWon() {
    ...
    document.querySelector("h3").innerHTML = banner + "<br>" + outcome + "." + " You've rolled the dice " + howManyTimes + " times. " + " Your balance is now " + balance;
}
